import { ssr, ssrAttribute, escape, createComponent, Dynamic, mergeProps as mergeProps$1 } from 'solid-js/web';
...
var SolidMarkdown = (opts) => {
  ...
  return ssr(_tmpl$, ssrAttribute("class", escape(options.class, true), false), escape(createComponent(MarkdownRoot, {
    context: {
      options,
      schema: html,
      listDepth: 0
    ...
    get node() {
      return options.renderingStrategy === "memo" ? generateNode() : node;
    }
  })));
};

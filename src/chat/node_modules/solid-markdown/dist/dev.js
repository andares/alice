import { template, insert, createComponent, memo, effect, className, Dynamic, mergeProps as mergeProps$1 } from 'solid-js/web';
  ...
  children: (child, index) => createComponent(Switch, {
    get children() {
      return [createComponent(Match, {
        ...
        get when() {
          return memo(() => child.type === "text")() && child.value !== "\n";
        },
        get children() {
